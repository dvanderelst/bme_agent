...
Same two-panel layout as Q1, but the single light detector now has a
red filter. A red LED and a green LED are placed at fixed positions NW
and NE of the robot, at equal distance. Panel 1 shows the body turned
toward the green LED, panel 2 shows it turned toward the red LED. Drawn
