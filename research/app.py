...
if st.session_state.get("authenticated"):
    ...
    st.success(f"Logged in as **{student.get('username', '?')}**.")
    st.write("Database connection: OK")
    st.caption("Survey scaffold — task picker and rubric questions land in the next iteration.")
    if st.button("Log out"):
        for k in ("authenticated", "student", "student_id"):
